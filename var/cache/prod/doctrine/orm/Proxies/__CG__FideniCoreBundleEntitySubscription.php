 ...
 */
class Subscription extends \Fideni\CoreBundle\Entity\Subscription implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', '' . "\0" . 'Fideni\\CoreBundle\\Entity\\Subscription' . "\0" . 'id', 'user', 'campaign', 'shares');
        }
    ...
    public function addShare(\Fideni\CoreBundle\Entity\Share $share)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'addShare', array($share));
    ...
    public function removeShare(\Fideni\CoreBundle\Entity\Share $share)
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'removeShare', array($share));
    ...
    public function getShareNumber()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getShareNumber', array());

        return parent::getShareNumber();
    }
